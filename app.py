...
detailed_actions = {
    "POLICY": [
        ("Write a standalone AI Use Policy",
         "Most schools don't have one yet. You don't need to start from scratch - the DfE guidance gives you a solid starting point. The important thing is getting something written down that staff can actually refer to. It doesn't have to be perfect first time. Get a draft to governors by the end of term and plan to review it termly, because this area moves fast."),
        ("Update your safeguarding and academic integrity policies",
         "AI changes the risk picture for both of these. JCQ updated their guidance on AI and malpractice - make sure your policies reflect that. On safeguarding, the question is straightforward: what happens if a student uses an AI tool and something concerning comes up? If your policy doesn't cover it, it needs to."),
        ("Get AI onto the governor agenda",
         "Governors need to understand what AI means for your school - not the technical detail, but the strategic picture. What tools are being used, what the risks are, and what the plan is. A 15-minute briefing at the next meeting is a good start. They can't provide oversight on something they haven't been told about."),
    ],
    "PROCESS": [
        ("Find out what tools staff are already using",
         "There's a good chance staff are using AI tools you don't know about. A quick, anonymous survey will give you the picture. This isn't about catching people out - it's about understanding what's happening so you can support it properly. The BCS found 36% of teachers using AI hadn't told their leadership team."),
        ("Complete DPIAs for your most-used AI tools",
         "Data Protection Impact Assessments sound more complicated than they are. Start with the tools staff use most. What data goes in? Where does it go? Who processes it? Your DPO can help with this. Getting these done means you can confidently say yes or no to tools rather than guessing."),
        ("Create and maintain an approved tool register",
         "A simple, shared list of which AI tools are approved, which aren't, and why. Keep it somewhere staff can find it easily. Update it when new tools come along or when existing ones change their terms. This prevents the situation where everyone's using different tools with nobody knowing what's been vetted."),
    ],
    "PEOPLE": [
        ("Appoint someone to lead on AI",
         "This doesn't need to be a new role or a huge time commitment. But somebody needs to own it. Without a named person, AI stays in the 'everyone's problem and nobody's responsibility' space. Pick someone with genuine interest and give them time to do it properly - even half a day a fortnight makes a difference."),
        ("Set up an AI working group",
         "Get a small group together from different departments - teaching staff, admin, IT, safeguarding. Meet half-termly. Share what's working, flag what isn't, and feed into policy decisions. The schools doing this well have found it creates a culture where people feel comfortable experimenting rather than hiding what they're doing."),
        ("Start structured AI CPD",
         "Move beyond the one-off twilight session. Staff need practical, hands-on training that's relevant to their specific role. Admin staff see admin examples. Teachers see teaching examples. Build confidence through doing, not just talking about it. The DfE and Chartered College now offer free training materials - use them."),
    ],
    "PROOF": [
        ("Start logging AI training",
         "Keep a record of who's been trained, when, and on what. This is basic accountability - if Ofsted ask what you've done to support staff with AI, you need something to show them. A shared spreadsheet is fine. It doesn't need to be complicated."),
        ("Document your tool approval decisions",
         "When you approve or reject an AI tool, write down why. This creates a paper trail that shows you're making considered decisions rather than reacting on the fly. It also helps when the next person asks about a similar tool - you've already done the thinking."),
        ("Put together a governance evidence pack",
         "Pull your policy, training records, tool register, and DPIA outcomes into one place. This isn't about creating extra work - it's about being able to show governors and inspectors that you've got a grip on AI in your school. Ofsted aren't inspecting AI specifically yet, but they will look at how well you manage risk and support staff."),
    ],
}
...
if st.button("GENERATE MY ACTION PLAN"):
    if not name or not email:
        ...
        pdf_bytes = generate_pdf(name, school if school else "your school", scores, detailed_actions)
